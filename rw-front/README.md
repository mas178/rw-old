# RW Front End Application

## Copy from camunda-bpm-webapp

This application is initialized to execute the following code.

```
git clone --depth 1 -b 7.5.0 --single-branch https://github.com/camunda/camunda-bpm-webapp.git
cd camunda-bpm-webapp/
rm -rf .git
git init
git add -A
git commit -m 'Initial commit'
git remote add origin https://github.com/mas178/rw-front.git
